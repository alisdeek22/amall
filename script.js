// Background Decorations
    ...
    function checkPassword() {
      if (passwordInput.value.trim() === '2122025') {
    ...
    // Image Carousel
    const images = [
      'https://i.ibb.co/5WyNfZRJ/Whats-App-Image-2025-12-27-at-10-33-31-PM-1.jpg',
      'https://i.ibb.co/4Rzc9Br8/Whats-App-Image-2025-12-27-at-10-33-31-PM-2.jpg',
      'https://i.ibb.co/0R9wpVGZ/Whats-App-Image-2025-12-27-at-10-33-31-PM.jpg',
    ];
    let currentSlide = 0;
    ...
    function updateLoveTimer() {
      const startDate = new Date('2025-02-21T00:00:00');
      const now = new Date();
    ...
    // Love Messages
    const loveMessages = [
      "💜انتي احلي حاجه طلعت بيها من السنه دي💜",
      "✨انتي اجمل صدفه حصلت ف حياتي✨"
    ];
